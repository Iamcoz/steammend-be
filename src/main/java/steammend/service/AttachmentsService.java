...
public class AttachmentsService {
	...
	/**
	 * 동일한 communityId를 가진 첨부파일 중 삭제되지 않은 첨부파일 조회
	 * 
	 * @param communityId
	 * @return
	 * @throws Exception
...
//	 */
//	public boolean downloadAttachment(Long id) throws MalformedURLException, Exception {
		
		
//		Optional<Attachments> atchEntity =  atchDAO.findById(id);
//		
//		if(atchEntity.get() == null) {
//			throw new MessageException("잘못된 파일 입니다.");
//		}
//		
//		AttachmentsDTO atchDTO = mapper.map(atchEntity.get(), AttachmentsDTO.class);
//		
//		String originalName = atchDTO.getOriginalName();
//		String uploadName = atchDTO.getUploadName();
//		
//		String contentDisposition = "attachment; filename=\"" + uploadName + "\"";
//		UrlResource resource = new UrlResource("file:" + atchDTO.getUploadPath());
